...
public:
    ...
    
    {
        ...
        {
            case 0:
                sample1 = osc1.square(frequency/2);
                break;
            case 1:
                sample1 = osc1.saw(frequency/2);
                break;
            default:
                sample1 = osc1.saw(frequency/2);
                break;
        ...
        {
            case 0:
                sample2 = osc2.saw(frequency * 2);
                break;
            case 1:
                sample2 = osc2.square(frequency * 1);
                break;
            default:
                sample2 = osc2.square(frequency * 1);
                break;
    ...
    void getFilter2Params (float* filter2Type, float* filter2Cutoff, float* filter2Res)
    {
        filter2Choice = *filter2Type;
        cutoff2 = *filter2Cutoff;
        resonance2 = *filter2Res;
    }
