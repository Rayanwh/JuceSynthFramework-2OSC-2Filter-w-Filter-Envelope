...
processor(p)
{
    ...
    filterPoleMenu.addItem("12 dB/oct", 1);
    filterPoleMenu.addItem("24 dB/oct", 2);
    //filterPoleMenu.addItem("36 dB/oct", 3);
    filterPoleMenu.setJustificationType(Justification::centred);
    addAndMakeVisible(&filterPoleMenu);
    filterPoleVal = new AudioProcessorValueTreeState::ComboBoxAttachment (processor.tree, "filterPole", filterPoleMenu);
...
void Filter::resized()
{
    ...
    filterPoleMenu.setBounds(area.removeFromTop(20));
